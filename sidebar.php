<href links different in integration, collaspe in class added server side in integration --> 
		...
		<div id="sidebar" class="sidebar-toggle">
			<ul class="nav nav-sidebar">
					...
					<li data-toggle="collapse" href="#agriculture-types" aria-expanded="true" aria-controls="chart-types">
						<a href="#"> 
							<i class="fa fa-area-chart" aria-hidden="true"></i><span>AGRICULTURE ALLIED</span>
						</a>
					</li>

					<li>
						<ul id="agriculture-types" class="sub-menu collapse">
							<li><a href="/domainB/">Livestock</a></li>
							<li><a href="/domainB/">Horticulture</a>
							</li>
							<li><a href="/domainB/">Fishery</a>
							</li>
							<li><a href="/domainB/">Others</a>
							</li>
						</ul>
						<li role="separator" class="divider"></li>
					</li>
